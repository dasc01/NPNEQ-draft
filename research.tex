...
Finally, \textsc{inq} was tested against a medium-to-high energy application, namely electronic stopping power (Fig.~\ref{fig:al_stopping}). 
...
\begin{figure}
\centering
\includegraphics[width=0.9\columnwidth]{figures/stopping_eph}
\caption{
