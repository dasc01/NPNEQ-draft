...
The rare earth perovskite nikelates RNiO$_3$ are host to a number of unique structural, electronic and magnetic transitions~\cite{Giovannetti2009,Hampel2017,Beyerlein2018}. The melting of the low-temperature antiferromagentic order in photoexcited nickelates within a few picoseconds~\cite{Caviglia2013}, suggested to be
